...
static PyGetSetDef Elkan_getsetters[] = {
    // Readonly
    {"centers", (getter) Elkan_get_centers, NULL, "The set of centers"},
    {NULL} // Sentinel
};
...
void init_elkan_type_fields(void) {
    ElkanType.tp_name = "fastkmeans.Elkan";
    ElkanType.tp_doc = "";
    ElkanType.tp_basicsize = sizeof(ElkanObject);
    ElkanType.tp_itemsize = 0;
    ElkanType.tp_flags = Py_TPFLAGS_DEFAULT | Py_TPFLAGS_BASETYPE;
    ElkanType.tp_new = PyType_GenericNew;
    ElkanType.tp_init = (initproc) Elkan_init;
    ElkanType.tp_dealloc = (destructor) Elkan_dealloc;
    ElkanType.tp_methods = Elkan_methods;
    ElkanType.tp_getset = Elkan_getsetters;
};
